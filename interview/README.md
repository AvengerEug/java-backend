...
* 有五种基础数据结构string、list、map、set、zset，除此此外还有hypeloglog、geo、bitmap。通常，我们可以充分利用这些数据结构，比如list可以利用它的特殊api实现堆、栈、队列的功能。而map的话，我们可以存储一些对象的机构、购物车信息。set和zset的话，我们可以用来去重、生成随机数等等。
